...
public class PooledByteBufAllocator extends AbstractByteBufAllocator implements ByteBufAllocatorMetricProvider {
    ...
    private static int DEFAULT_MAX_ORDER; // 8192 << 11 = 16 MiB per chunk
    private static int DEFAULT_TINY_CACHE_SIZE;
    private static int DEFAULT_SMALL_CACHE_SIZE;
    private static int DEFAULT_NORMAL_CACHE_SIZE;
    private static int DEFAULT_MAX_CACHED_BUFFER_CAPACITY;
    private static int DEFAULT_CACHE_TRIM_INTERVAL;
    private static boolean DEFAULT_USE_CACHE_FOR_ALL_THREADS;
    private static int DEFAULT_DIRECT_MEMORY_CACHE_ALIGNMENT;
