...
public final class ByteBufUtil {
    ...
    private static byte WRITE_UTF_UNKNOWN = (byte) '?';
    private static int MAX_CHAR_BUFFER_SIZE;
    private static int THREAD_LOCAL_BUFFER_SIZE;
    private static int MAX_BYTES_PER_CHAR_UTF8 =
