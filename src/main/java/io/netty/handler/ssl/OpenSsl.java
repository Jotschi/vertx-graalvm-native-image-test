...
public final class OpenSsl {
    ...
    private static InternalLogger logger = InternalLoggerFactory.getInstance(OpenSsl.class);
    private static Throwable UNAVAILABILITY_CAUSE;

    static List<String> DEFAULT_CIPHERS;
    static Set<String> AVAILABLE_CIPHER_SUITES;
    private static Set<String> AVAILABLE_OPENSSL_CIPHER_SUITES;
    private static Set<String> AVAILABLE_JAVA_CIPHER_SUITES;
    private static boolean SUPPORTS_KEYMANAGER_FACTORY;
    private static boolean SUPPORTS_HOSTNAME_VALIDATION;
    private static boolean USE_KEYMANAGER_FACTORY;
    private static boolean SUPPORTS_OCSP;

    static Set<String> SUPPORTED_PROTOCOLS_SET;
