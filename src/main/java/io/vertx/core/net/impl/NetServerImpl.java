...
public class NetServerImpl implements Closeable, MetricsProvider, NetServer {
	...
	/*
	 * Needs to be protected using the NetServerImpl monitor as that protects the listening variable In practice synchronized overhead should be close to zero
